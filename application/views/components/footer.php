<footer class="page-footer text-white">
	...
	<div class="footer-links">
		<div class="footer-link"><a href="<?= base_url() . "about" ?>">About</a></div>
		<div class="footer-link"><a href="<?= base_url() . "destinations" ?>">Destinations</a></div>
		<div class="footer-link"><a href="<?= base_url() . "shelf" ?>">Off the Shelf</a></div>
		<div class="footer-link"><a href="<?= base_url() . "adventure" ?>">Create an Adventure</a></div>
		<div class="footer-link"><a href="<?= base_url() . "luxury" ?>">Explore Luxury</a> </div>
		<div class="footer-link"><a href="<?= base_url() . "knowledges" ?>">Knowledge of the Place</a></div>
		<div class="footer-link"><a href="<?= base_url() . "covid" ?>">Covid Updates</a></div>
		<div class="footer-link"><a href="<?= base_url() . "contact" ?>">Contact</a></div>
	</div>

	<div class="container">
		<div class="row mb-4 d-flex justify-content-center">
			<div class="col-sm-6 col-md-2 text-center mb-4">
				<img style="max-width: 100%;position: relative;top: 7px;width: 112px;right: 14px;" alt="" src="<?= base_url() ?>assets/img/footer/footer_logo_5.png">
			</div>
